	...
	jQuery('#logo').fadeIn(600, function() {
		jQuery('h1').animate({opacity: '1', 'padding-top': '0'}, 500,function() {
			jQuery('h2').animate({opacity: '1', 'padding-top': '0'}, 500,function() {
				jQuery('h3').animate({opacity: '1', 'margin-top': '2em'}, 1000);
				if(jQuery(window).width()<767){	
					jQuery('#explore').animate({opacity: '1', 'margin-top': '2em'}, 1200);
				} else {
					jQuery('#explore').animate({opacity: '1', 'margin-top': '8em'}, 1200);
				}
			});
		});
	});
